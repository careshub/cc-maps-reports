 ...
 * functionality, then refer to `public/class-cc-maps-reports.php`
 *
 * @package   Community_Commons_Maps_Reports_Admin
 * @author  AuthorName
 */
class CC_Maps_Reports_Admin {
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_options_page(
			__( 'Maps and Reports', 'cc-maps-reports' ),
			__( 'Maps and Reports', 'cc-maps-reports' ),
			'manage_options',
			$this->plugin_slug,
	...
	public function add_action_links( $links ) {
		...
		return array_merge(
			array(
				'settings' => '<a href="' . admin_url( 'options-general.php?page=' . $this->plugin_slug ) . '">' . __( 'Settings', 'cc-maps-reports' ) . '</a>'
			),
			$links
		);
